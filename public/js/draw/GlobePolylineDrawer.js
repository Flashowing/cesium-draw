...
GlobePolylineDrawer.prototype = {
  ...
  okHandler: null,
  cancelHandler: null,
  dragIcon: 'http://222.178.182.14:18090/web/images/circle_red.png',
  ...
  startDrawPolyline: function(vueComponent, okHandler, cancelHandler) {
    var _this = this
  ...
  _createToolBar: function() {
    ...
    _this.vueComponent.$confirm('', '', {
      ...
      if (_this.okHandler) {
        ...
        var lonLats = _this._getLonLats(positions);
        _this.positions = positions;
        _this.okHandler(_this.vueComponent,positions, lonLats);
        _this.clear();
      } else {
        _this.clear();
      }
